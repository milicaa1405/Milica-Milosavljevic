...
<nav class="navbar navbar-expand-md navbar-light bg-light sticky-top">
	<div class="container-fluid">
		<a class="navbar-brand" href="index.php"><img class="img" src="img/icon.jpg"></a>
...
<div id="slides" class="carousel slide"  data-ride="carousel">
	...
	<div class="carousel-inner">
		<div class="carousel-item active">
			<img src="img/pocetna1.jpg" class="w-100">
			<div class="carousel-caption">
				<h1 class="display-2">Mix Parfemi</h1>
		...
		<div class="carousel-item">
			<img src="img/pocetna2.jpg" class="w-100">
			<div class="carousel-caption">
...
<div class="container-fluid padding">
	<div class="row text-center padding">
		<div class="col-xs-12 col-sm-6 col-md-4">
			...
			<p>Uz pomoć našeg sajta možete poručiti Vaš omiljeni parfem. Dostava na kućnu adresu u roku od 2 do 3 dana.</p>
		</div>
...
<div class="container-fluid padding" id="about">
	<div class="row padding">
		<div class="col-md-12 col-lg-6">
			<h2>O NAMA</h2>
			<p>Verni tradiciji dugoj 7 godina, sve generacije kupuju u našoj parfimeriji - od onih koji se vezuju za klasične, oprobane proizvode do onih koji žele najnovije, inovativne preparate.</p>
			<p>Mix Parfemi je 100% domaće preduzeće. Poverenje je stvarano decenijama i rezultira starim i novim kupcima.</p>
			...
			<p>Kod nas možete pronaći svetski poznate parfeme. Stalne akcije, sniženja i pokloni uz kupovinu su must-have kad je u pitanju Mix Parfemi parfimerija.</p>
		</div>
...
<div class="container-fluid padding">
	<div class="row padding">
		<div class="col-md-4">
			<div class="card">
				<img class="card-img-top" src="img/dior1.jpg">
				<div class="card-body">
					<h4 class="card-title">Dior Sauvage</h4>
	...
	<div class="container-fluid padding">
		<div class="row text-center">
			<div class="col-md-4">
				...
				<hr class="light">
				<p>011-100-100</p>
				<p>mixparfemi@gmail.com</p>
				<p>Uroša Trojanovića 3</p>
